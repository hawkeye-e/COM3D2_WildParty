...
namespace COM3D2.WildParty.Plugin.Core
{
    ...
    internal partial class CustomADVProcessManager
    {
        ...
        private static void ProcessADVLoadYotogiScene(ADVKagManager instance, ADVStep step)
        {
            ...
            switch (step.YotogiSetup.YotogiCode)
            {
                ...
                case Constant.YotogiSceneCode.ExpExchangeEvent:
                    ...
                    break;
                case Constant.YotogiSceneCode.LoveLoveTravel:
                    ProcessADV_Step_LoveLoveTravel_YotogiPlay(instance, step);
                    break;
            }
        }
        ...
        private static void ProcessADV_Step_LustfulMaid_YotogiPlay(ADVKagManager instance, ADVStep step)
        {
            StateManager.Instance.ModEventProgress = Constant.EventProgress.YotogiInit;
        ...
        private static void ProcessADV_Step_ManInLilies_YotogiPlay(ADVKagManager instance, ADVStep step)
        {
            StateManager.Instance.ModEventProgress = Constant.EventProgress.YotogiInit;
            ...
            GameMain.Instance.MainCamera.FadeOut(f_dg: delegate
            {
                ...
                if (step.YotogiSetup.MaidConvertToMan != null)
                    YotogiHandling.InitArrayForYotogiUsed(step.YotogiSetup.MaidConvertToMan.RatioPercent, step.YotogiSetup.IsClubOwnerMainCharacter);
                else
                    YotogiHandling.InitArrayForYotogiUsed();
        ...
        private static void ProcessADV_Step_LoveLoveTravel_YotogiPlay(ADVKagManager instance, ADVStep step)
        {
            StateManager.Instance.ModEventProgress = Constant.EventProgress.YotogiInit;
